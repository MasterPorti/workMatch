        ...
        <div className="p-10">
          ...
          <div className="mt-8">
            <h2 className="text-xl font-bold mb-4">
              Vacantes que coinciden con tus especialidades
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {vacantes
                .filter((vacante) => {
                  ...
                  const categoriasVacante = categoriasMatch[1]
                    .split(", ")
                    .map((cat) => cat.toLowerCase().trim());
                  const especialidadesUsuario = userData?.especialidades
                    ? userData.especialidades
                        .split(",")
                        .map((esp) => esp.toLowerCase().trim())
                    : [];

                  // Verificar si alguna categoría de la vacante coincide exactamente con alguna especialidad del usuario
                  return categoriasVacante.some((categoria) =>
                    especialidadesUsuario.some(
